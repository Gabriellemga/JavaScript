...
let nome = "Marcia Gabrielle";
console.log(`Olá ${nome}`);

//3-Crie uma variável chamada "nome" e atribua a ela o seu nome. Em seguida, utilize o alert para exibir a mensagem "Olá, [seu nome]!".//

let nome1 = "Marcia Gabrielle";
alert ( `Olá  ${nome1}`);
...
let numero = parseFloat(prompt("Escolha um numero positivo, negativo ou zero"));

if ( numero == 0 ) {
  console.log ( " Você escolheu o zero");
}
else { if ( numero < 0){
